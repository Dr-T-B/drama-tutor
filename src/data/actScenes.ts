...
export const actScenes: ActScene[] = [
...

  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        significance: 'The couplet\'s rhyme gives it the force of an aphorism — decisive after scenes of paralysis. Hamlet uses theatrical fiction to reveal political truth. AO4: the moment is self-referentially theatrical — Hamlet, a character in a play, decides to use a play to catch the truth.',
        aos: ['AO1', 'AO2', 'AO4'],
      },
      {
        speaker: 'Hamlet',
...

  {
    ...
    dramaticSignificance: 'Theatre literally performs the function Hamlet assigned it — catching the conscience of the king. The scene is structurally the hinge of the play: Hamlet now has what he considers proof. AO4: the play-within-a-play makes the theatrical form of Hamlet itself visible — the audience watches characters watching a play, creating layered theatrical self-consciousness.',
    keyQuotes: [
      {
        speaker: 'Gertrude',
    ...
    aoFocus: ['AO2', 'AO4'],
    examTip: 'Key for appearance/reality and revenge questions. The AO4 opportunity is exceptional here — the play-within-a-play is the most self-consciously theatrical moment in the canon. Always note that Hamlet is simultaneously director, audience, and actor.',
  },
...

  {
    ...
    aoFocus: ['AO1', 'AO2', 'AO3', 'AO4', 'AO5'],
    examTip: 'The closing scenes are frequently neglected in revision — but "The rest is silence" and the sparrow speech are both highly method-rich. The Horatio survival parallel with the Duchess of Malfi\'s Delio is a strong AO4 point: both plays end with a marginal survivor tasked with telling the story.',
  },
    ...
    keyQuotes: [
      {
        ...
        significance: 'Antonio\'s opening moral framework is immediately ironised by the court it describes. Webster establishes the standard only to demonstrate its total absence. AO5: Kott\'s reading of the court as a totalitarian machine makes Antonio\'s naive idealism a political indictment from within.',
        aos: ['AO1', 'AO2', 'AO5'],
      },
      {
...

  {
    ...
    dramaticSignificance: 'The scene literalises the court\'s monitoring of the Duchess\'s body — her physical interior becomes political information. Bosola reads bodily signs rather than verbal ones, exposing the total reach of Ferdinand\'s surveillance system. AO4: on stage the apricot scene is physically uncomfortable — the audience watches a woman\'s body being read against her will.',
    keyQuotes: [
      {
        speaker: 'Bosola',
        ...
        significance: 'Bosola reads the Duchess\'s body for signs of pregnancy — surveillance is intimate and bodily here. "Methinks" performs plausible deniability while the reading is hostile and penetrating. AO4: on stage, the gaze is physical — the audience sees Bosola seeing the Duchess.',
        aos: ['AO1', 'AO2', 'AO4'],
      },
      {
        speaker: 'Bosola',
        ...
        significance: 'Bosola reduces the body to decomposing organic matter — she is not a person but pharmacy-shelf content. "Green mummy" (preserved corpse used in medicine) anticipates her actual death. AO5: Dollimore reads this as the ideological exposure of the body as undifferentiated matter beneath all social distinction.',
        aos: ['AO1', 'AO2', 'AO5'],
      },
    ],
...

  {
    ...
    dramaticSignificance: "The scene marks the transition from secret happiness to open persecution. The Duchess's assertion of her body's vitality against Ferdinand's desire to fix her in static, sexless form is one of the play's key statements of female selfhood. AO4: the physical intimacy of Ferdinand's invasion of the bedroom space is one of the play's most uncomfortable theatrical moments — he has used a key, entering her most private space.",
    keyQuotes: [
      {
        speaker: 'Duchess',
        ...
        significance: 'The Duchess insists on the vitality of her own body against Ferdinand\'s desire to fix her in static, sexless form. Alabaster was the material of tomb effigies — she knows he wants her immobilised and, ultimately, dead. AO4: on stage, this is a physical claim — the actress asserting the body the brothers want to control.',
        aos: ['AO1', 'AO2', 'AO4'],
      },
      {
        speaker: 'Duchess',
...

  {
    ...
    dramaticSignificance: 'The dead hand and wax figures are Webster\'s most extreme theatrical staging — he makes the stage literally produce what terror looks like. AO4: the props are central to the scene\'s effect; the Duchess\'s horror must be performed against physical objects. AO5: Dollimore reads the wax figures as an ideological exposure of power\'s need to stage death as spectacle before it becomes reality.',
    keyQuotes: [
      {
        speaker: 'Duchess',
      ...
      },
      {
        ...
        significance: 'The word "yet" is devastating — the Duchess acknowledges that madness might come. The controlled syntax of the sentence performs the very sanity it asserts. AO5: Whigham reads this as the Duchess\'s most heroic moment — she maintains rational selfhood in the face of Ferdinand\'s assault on it.',
        aos: ['AO1', 'AO2', 'AO5'],
      },
    ],
    ...
    aoFocus: ['AO2', 'AO4', 'AO5'],
    examTip: 'The wax figures scene is rich for AO4 — it is one of the most explicitly theatrical sequences in the Jacobean repertoire. Always note the stagecraft: darkness, props, the presence of Bosola as observer. The theatrical metaphor quote is one of the most conceptually layered in the play.',
  },

  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        significance: 'The imperative is simultaneously a command and a stage direction — Webster inscribes the theatrical event into the dialogue. The double caesura enacts psychological fragmentation; "she died young" suppresses guilt beneath apparent elegy. AO4: on stage the pause after each caesura is Ferdinand\'s dissociation made visible.',
        aos: ['AO1', 'AO2', 'AO4'],
      },
    ],
    ...
    aoFocus: ['AO1', 'AO2', 'AO3', 'AO4', 'AO5'],
    examTip: 'The most examined scene in The Duchess of Malfi. "I am Duchess of Malfi still" requires tautological assertion, anaphoric self-naming, and monosyllabic rhythm as methods — not just content paraphrase. Ferdinand\'s "Cover her face" is rich for AO4: the embedded stage direction and the double caesura are the two key analytical moves.',
  },

  {
    ...
    keyQuotes: [
      ...
      },
      {
        ...
        significance: 'Human agency is negated entirely — fate is a game played by indifferent forces. "Merely" strips human dignity absolutely. AO3: Jacobean Calvinist predestination theology — election and damnation are not earned. AO5: Belsey argues Webster dramatises "the contradictions of a subject position that is simultaneously wilful and subjected."',
        aos: ['AO1', 'AO2', 'AO3', 'AO5'],
      },
    ],
    ...
    aoFocus: ['AO2', 'AO3', 'AO4', 'AO5'],
    examTip: 'Use lycanthropy for madness questions and "tennis-balls" for death/fate questions. The contrast between Ferdinand\'s genuine psychological collapse and Hamlet\'s performed madness is a productive AO4 cross-text observation.',
...

  {
    ...
    dramaticSignificance: "The closing catastrophe implicates everyone, including Bosola, who sought justice but dealt it carelessly. The accidental killing of Antonio — the one innocent man — is the play's cruelest stroke. Delio's closing speech frames the tragedy as a meditation on transience. The surviving child and Delio mirror Horatio and Fortinbras in Hamlet — the witnessing figures who carry the story forward.",
    keyQuotes: [
      {
        speaker: 'Bosola',
        ...
        significance: 'Bosola recognises his own moral hollowness — he is a dead structure, not a living conscience. The vaulted grave yields no echo: guilt is not confessed but swallowed. AO5: Dollimore reads Bosola as the figure who exposes the ideological contradictions of service — he performs the court\'s violence while knowing its wrongness.',
        aos: ['AO1', 'AO2', 'AO5'],
      },
      {
        speaker: 'Bosola',
    ...
    aoFocus: ['AO1', 'AO2', 'AO3', 'AO5'],
    examTip: 'The final act is frequently neglected in revision. Delio\'s snow-print image and Bosola\'s "In a mist" are both highly method-rich and rarely used by other students — strong differentiators at A*. For AO4: compare Delio\'s survival and narration with Horatio\'s in Hamlet.',
