  ...
  { id: 'mal-2017-a', year: 2017, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on the corrupted court", ao_focus: ['AO4'], topic_sentence: "Critics have contextualised Webster's corrupted court within Jacobean anxieties about the Spanish court, Italian politics, and the nature of absolutist power." },
      ],
      sentence_stems: {
        ...
        AO4: "Connecting Webster's corrupted court to [context/other text], it becomes clear that...",
      },
      critic_positions: [
  ...
  { id: 'mal-2017-b', year: 2017, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on uncertainty", ao_focus: ['AO4'], topic_sentence: "Critics have read the play's uncertainty as reflecting Jacobean anxieties about knowledge, power, and the limits of human judgement." },
      ],
      sentence_stems: {
        ...
        AO4: "The uncertainty in Malfi connects to [context/theme] in that...",
      },
      critic_positions: [
  ...
  { id: 'mal-2018-a', year: 2018, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on family", ao_focus: ['AO4'], topic_sentence: "Critics have read Webster's family relationships through psychoanalytic, feminist, and historicist lenses, finding in them the distorted reflection of Jacobean anxieties about inheritance and female sexuality." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's presentation of family connects to [context/theme] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2018-b', year: 2018, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on reputation", ao_focus: ['AO4'], topic_sentence: "Critics have read reputation in Malfi as a specifically Jacobean ideological construction — one that reflects anxieties about class, gender, and the Italian setting's perceived moral laxity." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's use of reputation connects to [context] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2019-a', year: 2019, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on religion", ao_focus: ['AO4'], topic_sentence: "Critics have contextualised the play's religious dimension within the Jacobean anxieties about Catholicism, ecclesiastical corruption, and the relationship between spiritual and temporal authority." },
      ],
      sentence_stems: {
        ...
        AO4: "The religious dimension of Malfi connects to [context/theme] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2019-b', year: 2019, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on excess", ao_focus: ['AO4'], topic_sentence: "Critics have debated whether the play's excess is a formal flaw or a deliberate aesthetic strategy — and whether Webster endorses or critiques the violence he stages." },
      ],
      sentence_stems: {
        ...
        AO4: "The theme of excess in Malfi connects to [context/genre] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2021-a', year: 2021, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on the Duchess and Bosola", ao_focus: ['AO4'], topic_sentence: "Critics have debated whether Bosola's turn constitutes genuine moral awakening or merely the belated guilt of a man who has run out of other options." },
      ],
      sentence_stems: {
        ...
        AO4: "The Duchess-Bosola relationship connects to [theme/context] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2021-b', year: 2021, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on death", ao_focus: ['AO4'], topic_sentence: "Critics have read the play's preoccupation with death within the contexts of Jacobean memento mori traditions, revenge tragedy conventions, and Webster's distinctive theatrical aesthetic." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's presentation of death connects to [genre/context] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2022-a', year: 2022, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on imagery", ao_focus: ['AO4'], topic_sentence: "Critics have analysed Webster's imagery within the contexts of Jacobean emblematic tradition, Mannerist aesthetics, and the play's relationship to the visual arts." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's imagery connects to [context/tradition] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2022-b', year: 2022, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on genre", ao_focus: ['AO4'], topic_sentence: "Critics have debated the extent to which Malfi fulfils or subverts the revenge tragedy genre — and what Webster's relationship to generic convention reveals about his wider dramatic vision." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's relationship to revenge tragedy connects to [context/other texts] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2023-a', year: 2023, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on secrets and lies", ao_focus: ['AO4'], topic_sentence: "Critics have read the play's economy of secrets within Jacobean anxieties about surveillance, counsel, and the relationship between public performance and private truth." },
      ],
      sentence_stems: {
        ...
        AO4: "The play's economy of secrets connects to [context/theme] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2023-b', year: 2023, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on gender", ao_focus: ['AO4'], topic_sentence: "Feminist critics have reclaimed the play as a foundational text for gender analysis, while historicist readings have contextualised its gender politics within Jacobean constructions of femininity and aristocratic honour." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's gender politics connect to [context/tradition] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2024-a', year: 2024, play: 'MAL', section: 'B', option: 'EITHER',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on social critique", ao_focus: ['AO4'], topic_sentence: "Critics have debated the extent to which Malfi constitutes a genuine social critique or merely exploits social corruption for theatrical effect." },
      ],
      sentence_stems: {
        ...
        AO4: "Webster's social critique connects to [context/tradition] through...",
      },
      critic_positions: [
  ...
  { id: 'mal-2024-b', year: 2024, play: 'MAL', section: 'B', option: 'OR',
    ...
    framework: {
      ...
      paragraph_plan: [
        ...
        { topic: "Critical perspectives on Ferdinand", ao_focus: ['AO4'], topic_sentence: "Critics have debated Ferdinand's motivation — whether his obsession is primarily incestuous, ideological, or psychological — and what his disintegration reveals about the play's wider social vision." },
      ],
      sentence_stems: {
        ...
        AO4: "Ferdinand's presentation connects to [context/theme] through...",
      },
      critic_positions: [
