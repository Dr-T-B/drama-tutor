        ...
        packages: [
          {
            ...
            meaning: 'The Duchess\'s identity is not contingent on title or marriage — her selfhood is the claim. The monosyllabic plainness resists Bosola\'s psychological tyranny. Whigham identifies this assertion as "simultaneously transgressive and self-annihilating" — she claims sovereignty at the precise moment it is extinguished. AO3: Jacobean women were legally dissolved into male identity upon marriage; Webster makes this line a direct counter-ideological claim.',
            aos: ['AO1', 'AO2', 'AO3'],
          },
          {
            speaker: 'The Duchess',
            ...
            meaning: 'The relic metaphor exposes the brothers\' control as sacred stasis — to be preserved is to be immobilised. The rhetorical question asserts her particularity ("only I") against a system that would make her generic and passive. Luckyj reads this as the Duchess\'s earliest refusal of the category of "woman" as passivity.',
            aos: ['AO1', 'AO2', 'AO3'],
          },
          {
            speaker: 'The Duchess',
      ...
      },
      {
        ...
        packages: [
          ...
          },
          {
            ...
            meaning: 'Ferdinand\'s violence cannot locate its proper object — it displaces between Antonio and himself, suggesting the desire to kill the Duchess is also a desire to destroy himself. Psychoanalytic readings connect the displaced violence to incestuous desire that Ferdinand cannot consciously name.',
            aos: ['AO2', 'AO3'],
          },
          {
      ...
      },
      {
        ...
        packages: [
          ...
          },
          {
            ...
            meaning: 'Bosola reduces the Duchess\'s body to decomposing organic matter — she is not a person but pharmacy-shelf content. "Green mummy" (preserved corpse used in Jacobean medicine) anticipates her actual death. Dollimore reads this as the ideological exposure of the body as undifferentiated matter beneath all social distinction.',
            aos: ['AO2', 'AO3'],
          },
        ],
      },
      ...
      },
      {
        ...
        packages: [
          ...
          },
          {
            ...
            meaning: 'Antonio\'s opening description of the ideal court is immediately and systematically ironised by the play that follows. Webster establishes the moral standard only to demonstrate its total absence. Kott reads this as Webster\'s political indictment from within — the ideal court is articulated by the man who will be destroyed by the actual one.',
            aos: ['AO1', 'AO2', 'AO3'],
          },
        ],
      },
      ...
      },
      {
        ...
        packages: [
          ...
          },
          {
            ...
            meaning: 'Bosola recognises his own moral hollowness — he is a dead structure, not a living conscience. The vaulted grave yields no echo: guilt is not confessed but swallowed. Dollimore reads Bosola as the figure who exposes the ideological contradictions of service — he performs the court\'s violence while knowing its wrongness, yet cannot act otherwise.',
            aos: ['AO2', 'AO3'],
          },
          {
            speaker: 'Bosola',
