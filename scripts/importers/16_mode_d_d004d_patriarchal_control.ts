// Mode D — D004D Route A Patriarchal Control importer (idempotent)
...
section('16 — D004D Route A Patriarchal Control (20 stems)')

const __dirname = dirname(fileURLToPath(import.meta.url))
const jsonPath   = resolve(__dirname, '../../data/mode_d/d004_duchess_patriarchal_control_stems.json')
...
console.log('\n✅  16 D004D Patriarchal Control complete\n')
